...
from ryu.lib.packet import packet, ethernet, lldp, ipv4, udp, tcp, arp, ether_types
...
class Layer2Switch(app_manager.RyuApp):
    ...
    def cc_flow_mod_handler(self, ev):
        ...
        print("app_manager: Event %s Received *** handler starting ...", ev.__class__.__name__)
    ...
    def get_topology_data(self, ev):
        ...
        window_switches = get_all_window_switch(self.topology_api_app)
