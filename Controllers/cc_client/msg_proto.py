...
TFLCP_PACKET_IN_PACK_STR = '!QQQQQ17s7x17s7x'  # need more work here fix just for time being
TFLCP_PACKET_IN_SIZE = 96
assert struct.calcsize(TFLCP_PACKET_IN_PACK_STR) + TFLCP_HEADER_SIZE == TFLCP_PACKET_IN_SIZE

TFLCP_FLOW_MOD_PACK_STR = '!QQQ17s5xH'
TFLCP_FLOW_MOD_SIZE = 56
...
TFLCP_SWITCH_CONTROLLER_MAP_UPDATE_STR = '!H'
TFLCP_SWITCH_CONTROLLER_MAP_UPDATE_SIZE = 10
assert struct.calcsize(TFLCP_SWITCH_CONTROLLER_MAP_UPDATE_STR) + TFLCP_HEADER_SIZE == TFLCP_SWITCH_CONTROLLER_MAP_UPDATE_SIZE
