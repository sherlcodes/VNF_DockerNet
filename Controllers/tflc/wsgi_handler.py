...
class StatsController(wsgi.ControllerBase):
    ...
    def show_index(self,req):
        data = {"controller_list":"http://172.16.117.50:8080/stats/controller_list",
        "Name":"http://172.16.117.50:8080/stats/app_name",
        "show_index":"http://172.16.117.50:8080/index",
        "get_app_name":"http://172.16.117.50:8080/stats/app_name",
        "get_controller_list":"http://172.16.117.50:8080/stats/controller_list",
        "get_lc_topo":"http://172.16.117.50:8080/stats/lc_topo",
        "set_lc_topo":"http://172.16.117.50:8080/stats/lc_topo[POST]",
        #"get_dp_win": "http://172.16.117.50:8080/stats/dp_win",
        #"set_dp_win": "http://172.16.117.50:8080/stats/dp_win[POST]",
        "get_controller":"http://172.16.117.50:8080/stats/controller/{lcid}",
        "get_datapath_list":"http://172.16.117.50:8080/stats/datapath_list",
        "get_datapath":"http://172.16.117.50:8080/stats/datapath/{dpid}",
        "get_host":"http://172.16.117.50:8080/stats/host/{lcid}",
        "get_update_counter":"http://172.16.117.50:8080/stats/get_update_counter",
        "set_update_counter":"http://172.16.117.50:8080/stats/set_update_counter",
        "start_switch_change":"http://172.16.117.50:8080/stats/start_switch_change"}
    ...
    def get_update_counter(self, req):
        reply = {}
        reply["update_counter"] = self.app_manager.UPDATE_COUNTER
        body = json.dumps(reply)
        return Response(content_type='application/json', body=body)

    def set_update_counter(self, req):
        self.app_manager.UPDATE_COUNTER = 0
        reply = {}
        reply["updated"] = True
        body = json.dumps(reply)
        return Response(content_type='application/json', body=body)

    def start_switch_change(self, req):
        self.app_manager._switch_controller_config_change()
        reply = {}
        reply["status"] = True
        body = json.dumps(reply)
        return Response(content_type='application/json', body=body)
